...
function MobileNavbar({ showNav, closeNav }: Props) {
  ...
  return (
    <div>
      ...
      />
      <div
        className={`text-white ${navOpen}fixed justify-center flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-indigo-900 space-y-6 z-[10000]`}
      >
        {navLink.map((link) => {
          return (
